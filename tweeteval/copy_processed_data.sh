...
#  rm -rf /home/thz/transfer2/finetune/data/${task}/hash_10*
  ...
  scp thz@10.21.4.51:/home/thz/transfer2/finetune/data/${task}/\{train_fuldata_bt_hashseg_top20_textfirst.json,dev_fuldata_bt_hashseg_top20_textfirst.json,test_fuldata_bt_hashseg_top20_textfirst.json\} /home/user/transfer2/finetune/data/${task}/
