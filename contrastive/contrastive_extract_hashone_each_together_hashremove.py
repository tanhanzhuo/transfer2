...
for tmp in range(args.splits):
    files.append(open('./selected_hashremove_thre'+str(args.thre)+'_num'+str(args.num)+'_'+str(tmp)+'.json', 'w', encoding='utf-8'))
...
with open('./selected_hashremove_thre'+str(args.thre)+'_num'+str(args.num) + '_index.json', 'w', encoding='utf-8') as f:
