...
parser.add_argument("--output_dir", default='/work/transfer2/hashtag/data_hash_100_1000/token', type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--dataset_path", default='/work/transfer2/hashtag/data_hash_100_1000', type=str, required=False, help="dataset name")
