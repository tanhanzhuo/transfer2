...
if __name__ == "__main__":
    ...
    r_dir = '/work/test/finetune_newdata/convert_model/pd_group_new/'
    for task in ['ner-16','ner-17']:#['pos-ritter', 'pos-ark', 'pos-tb', 'ner-16', 'ner-17']:      
        # for model_name in [r_dir+'100000/', r_dir+'200000/',r_dir+'300000/', r_dir+'500000/',r_dir+'600000/', r_dir+'700000/']:#[r_dir+'bertweet/', r_dir+'400000/', r_dir+'800000/']:#, r_dir+'840000/', r_dir+'960000/']:
        for model_name in [r_dir+'5000_1e5/', r_dir+'10000_1e5/', r_dir+'15000_1e5/', r_dir+'20000_1e5/', r_dir+'25000_1e5/', r_dir+'30000_1e5/',
            r_dir+'5000_1e4/', r_dir+'10000_1e4/', r_dir+'15000_1e4/', r_dir+'20000_1e4/', r_dir+'25000_1e4/', r_dir+'30000_1e4/', r_dir+'35000_1e4/',
            r_dir+'5000_3e5/', r_dir+'10000_3e5/', r_dir+'15000_3e5/', r_dir+'20000_3e5/', r_dir+'25000_3e5/', r_dir+'30000_3e5/', r_dir+'35000_3e5/', r_dir+'40000_3e5/', r_dir+'45000_3e5/', r_dir+'50000_3e5/', r_dir+'55000_3e5/']:
            ave_metric = []
