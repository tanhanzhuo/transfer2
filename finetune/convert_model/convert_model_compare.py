...
import paddle
import torch
# from paddlenlp.transformers import  RobertaModel as PDBertForMaskedLM
from modeling import  RobertaModel as PDBertForMaskedLM
# from transformers import  RobertaModel as PTBertForMaskedLM
# from transformers import AutoModel as PTBertForMaskedLM
from modeling_hf import RobertaModel as PTBertForMaskedLM
...
def test_forward():
    ...
    # model_torch = PTBertForMaskedLM.from_pretrained("/work/test/finetune/continue/bertweet")
    # model_paddle = PDBertForMaskedLM.from_pretrained("/work/test/finetune/continue/bertweet")
    model_torch = PTBertForMaskedLM.from_pretrained("/work/test/pretrain_hashtag/keyphrase/pretrain/tmp_group/950000")
    model_paddle = PDBertForMaskedLM.from_pretrained("/work/test/finetune_newdata/convert_model/pd_group/950000")
    model_torch.eval()
    model_paddle.eval()
    np.random.seed(42)
    x = np.random.randint(
...
if __name__ == "__main__":
    ...
    #     "/work/test/hf/tmp/120000/pytorch_model.bin",
    #     "/work/test/finetune/continue/120000/model_state.pdparams")
    # convert_pytorch_checkpoint_to_paddle(
    #     "/work/test/finetune/continue/ernie/pytorch_model.bin",
    #     "/work/test/finetune/continue/ernie/model_state.pdparams")
    test_forward()
