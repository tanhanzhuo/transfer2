...
parser.add_argument("--output_dir", default='/work/transfer2/emoji/cluster_train/data', type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--dataset_path", default='/work/transfer2/emoji/cluster_train', type=str, required=False, help="dataset name")
