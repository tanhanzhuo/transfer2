...
def load_pretrained(model_name, max_seq_length=130):
    """
    ...
    if "bertweet" in model_name:
        model = RobertaForMulti.from_pretrained(model_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label-map', type=str,default='7',#'{"0": ["Ġworse", "Ġincompetence", "ĠWorse", "Ġblamed", "Ġsucked"], "1": ["ĠCris", "Ġmarvelous", "Ġphilanthrop", "Ġvisionary", "Ġwonderful"]}',
