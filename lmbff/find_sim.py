...
parser.add_argument('--dataset',
                    default='sem21-task7-humor,sem22-task6-sarcasm,stance,eval-stance,eval-emotion,eval-irony,eval-offensive,eval-hate',
                    type=str)
    ...
    for sp in ['train', 'dev', 'test']:
        ...
        if sp == 'train':
            ...
            for idx in range(len(data_sem[sp])):
                one = data_sem[sp][idx]
                lab = CONVERT[dataset_one][one['labels']]
